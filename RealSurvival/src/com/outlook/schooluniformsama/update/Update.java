...
public class Update {
	...
	public final static long now_version = 214;
	public final static String now_version_show="0.3.6";
	...
	public static Update getUpdate(String url){
        ...
        try {
        	//InputStream in = new FileInputStream(new File(".\\update.properties"));
