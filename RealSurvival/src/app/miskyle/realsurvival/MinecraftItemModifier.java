...
public class MinecraftItemModifier {
  ...
  public void setUpItemList(JComboBox<String> box) {
    ...
    if (ConfigManager.getBukkitVersion() >= 13) {
      ITEM_LIST = ("POTION,MILK_BUCKET,APPLE,MUSHROOM_STEW," + "BREAD,PORKCHOP,COOKED_PORKCHOP,GOLDEN_APPLE,"
          + "ENCHANTED_GOLDEN_APPLE,COD,SALMON,BEEF,DRIED_KELP," + "MELON_SLICE,COOKIE,POISONOUS_POTATO,COOKED_SALMON,"
          ...
          + "MUTTON,COOKED_MUTTON,BEETROOT,BEETROOT_SOUP," + "GOLDEN_CARROT,RABBIT").split(",");
    } else {
      ITEM_LIST = ("SPECKLED_MELON FERMENTED_SPIDER_EYE RABBIT RABBIT_FOOT "
          ...
          + "RABBIT_STEW MUTTON BEETROOT BEETROOT_SOUP MILK_BUCKET " + "POTION COOKED_CHICKEN").split(" ");
    }
