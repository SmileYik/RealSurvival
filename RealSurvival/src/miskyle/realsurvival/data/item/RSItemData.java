...
public class RSItemData {
  ...
  public RSItemData(RSEntry<Double, Double> sleep, RSEntry<Double, Double> thirst, RSEntry<Double, Double> energy,
      RSEntry<Double, Double> hunger, RSEntry<Double, Double> health, RSEntry<Double, Double> temperature,
  ...
  public RSItemData(String[] sleep, String[] thirst, String[] energy, String[] hunger, String[] health,
      String[] temperature, double weight, DrugData drug) {

    this.energy = new RSEntry<Double, Double>(Double.parseDouble(energy[0]), Double.parseDouble(energy[1]));
    this.sleep = new RSEntry<Double, Double>(Double.parseDouble(sleep[0]), Double.parseDouble(sleep[1]));
    this.thirst = new RSEntry<Double, Double>(Double.parseDouble(thirst[0]), Double.parseDouble(thirst[1]));
    this.hunger = new RSEntry<Double, Double>(Double.parseDouble(hunger[0]), Double.parseDouble(hunger[1]));
    this.health = new RSEntry<Double, Double>(Double.parseDouble(health[0]), Double.parseDouble(health[1]));
    this.temperature = new RSEntry<Double, Double>(Double.parseDouble(temperature[0]),
        Double.parseDouble(temperature[1]));
    this.weight = weight;
    this.drugData = drug;
  }
  ...
  public void setTemperature(String[] str) {
    this.temperature = new RSEntry<Double, Double>(Double.parseDouble(str[0]), Double.parseDouble(str[1]));
  }
