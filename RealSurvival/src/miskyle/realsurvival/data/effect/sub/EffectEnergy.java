...
public class EffectEnergy extends RsEffect {

  public EffectEnergy(String pluginName) {
    super(pluginName);
  }
  ...
  public void effect(Player player, StatusType type, int amplifier, int duration) {
    ...
    pd.addEffect(StatusType.ENERGY, getEffectName(type), amplifier / 100D, duration);
  }
