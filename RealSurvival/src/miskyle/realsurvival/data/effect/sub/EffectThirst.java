...
public class EffectThirst extends RsEffect {

  public EffectThirst(String pluginName) {
    super(pluginName);
  }
  ...
  public void effect(Player player, StatusType type, int amplifier, int duration) {
    ...
    pd.addEffect(StatusType.THIRST, getEffectName(type), amplifier / 100D, duration);
  }
