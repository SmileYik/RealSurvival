...
public class CubeArrayCommands {
  ...
  @Cmd(subCmd = { "finish" }, args = {
      "" }, des = "cmd.des.cube-array.finish", permission = "RealSurvival.Command.CubeArray")
  public void finish(Player p, String[] args) {
    BlockArrayCreator.creat(p);
  }

  @Cmd(subCmd = { "cancel" }, args = {
      "" }, des = "cmd.des.cube-array.cancel", permission = "RealSurvival.Command.CubeArray")
  public void cancel(Player p, String[] args) {
    BlockArrayCreator.cancel(p);
  }

  @Cmd(subCmd = { "chooseBlock" }, args = {
      "" }, des = "cmd.des.cube-array.choose-block", permission = "RealSurvival.Command.CubeArray")
  public void setMainBlock(Player p, String[] args) {
    BlockArrayCreator.chooesBlock(p);
  }

  @Cmd(subCmd = { "setName" }, args = { "",
      "cmd.args.cube-array.name" }, des = "cmd.des.cube-array.set-name", permission = "RealSurvival.Command.CubeArray")
  public void setCubeArrayName(Player p, String[] args) {
    BlockArrayCreator.setName(p, args[1]);
  }

  @Cmd(subCmd = { "setCompass" }, args = { "",
      "cmd.args.cube-array.compass" }, des = "cmd.des.cube-array.set-compass", permission = "RealSurvival.Command.CubeArray")
