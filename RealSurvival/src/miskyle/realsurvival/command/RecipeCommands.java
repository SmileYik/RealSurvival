...
public class RecipeCommands {
  @Cmd(subCmd = { "reload" }, 
      args = { "" }, 
      des = "cmd.des.recipe.reload",
      permission = "RealSurvival.Recipe.Reload",
      needPlayer = false)
  ...
  @Cmd(subCmd = { "fr", "create" }, 
      args = { "","","cmd.args.fr.create.recipe-name","cmd.args.fr.create.machine-name","cmd.args.fr.create.forge-time" ,"cmd.args.fr.create.min-temperature" ,"cmd.args.fr.create.max-temperature" }, 
      des = "cmd.des.fr.create",
      permission = "RealSurvival.Recipe.FurnaceRecipeCreate")
  public void createFurnaceRecipe(Player p,String[] args) {
    //rsr ctr create [recipeName] [machineName] [forgeTime] [minTemperature] [maxTemperature]
    Integer forgeTime = getInt(args[4]);
    ...
    FurnaceRecipe recipe = new FurnaceRecipe(args[2], args[3], null, forgeTime, null, null, maxTemperature,minTemperature);
    String machineTitle = MachineManager.getMachineData(args[3]).getRight();
