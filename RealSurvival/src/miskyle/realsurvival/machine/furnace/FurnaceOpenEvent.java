  ...
  public void run() {
    ...
    if (recipe == null) {
      for (int slot : Furnace.TEMPERATURE_SLOTS) {
        holder.getInventory().setItem(slot, GuiItemCreater.getItem("WHITE_STAINED_GLASS_PANE", "STAINED_GLASS_PANE",
            (short) 0, I18N.tr("machine.furnace.temperature", _2f(temperature))));
      }
      return;
    }
    ...
    if (recipe.getMinTemperature() >= 0) {
      ...
      if (temperature < 0) {
        for (int slot : Furnace.TEMPERATURE_SLOTS) {
          holder.getInventory().setItem(slot, GuiItemCreater.getItem("LIGHT_BLUE_STAINED_GLASS_PANE",
              "STAINED_GLASS_PANE", (short) 3, I18N.tr("machine.furnace.temperature", _2f(temperature))));
        }
      } else if (temperature >= recipe.getMaxTemperature()) {
        for (int slot : Furnace.TEMPERATURE_SLOTS) {
          holder.getInventory().setItem(slot, GuiItemCreater.getItem("BROWN_STAINED_GLASS_PANE", "STAINED_GLASS_PANE",
              (short) 12, I18N.tr("machine.furnace.temperature", _2f(temperature))));
        }
      } else {
      ...
      if (temperature >= 0) {
        for (int slot : Furnace.TEMPERATURE_SLOTS) {
          holder.getInventory().setItem(slot, GuiItemCreater.getItem("ORANGE_STAINED_GLASS_PANE", "STAINED_GLASS_PANE",
              (short) 1, I18N.tr("machine.furnace.temperature", _2f(temperature))));
        }
      } else if (temperature <= recipe.getMaxTemperature()) {
        for (int slot : Furnace.TEMPERATURE_SLOTS) {
          holder.getInventory().setItem(slot, GuiItemCreater.getItem("BLUE_STAINED_GLASS_PANE", "STAINED_GLASS_PANE",
              (short) 11, I18N.tr("machine.furnace.temperature", _2f(temperature))));
        }
      } else {
        double temPass = temperature / recipe.getMinTemperature();
        if (temPass >= 0.25) {
    ...
    if (pass >= 0.25) {
      holder.getInventory().setItem(Furnace.PROGRESS_SLOTS.get(3), GuiItemCreater.getItem("CYAN_STAINED_GLASS_PANE",
          "STAINED_GLASS_PANE", (short) 9, I18N.tr("machine.furnace.progress", _2f(pass * 100))));
    }
    if (pass >= 0.5) {
      holder.getInventory().setItem(Furnace.PROGRESS_SLOTS.get(2), GuiItemCreater.getItem("LIME_STAINED_GLASS_PANE",
          "STAINED_GLASS_PANE", (short) 5, I18N.tr("machine.furnace.progress", _2f(pass * 100))));
    }
    if (pass >= 0.75) {
      holder.getInventory().setItem(Furnace.PROGRESS_SLOTS.get(1), GuiItemCreater.getItem("YELLOW_STAINED_GLASS_PANE",
          "STAINED_GLASS_PANE", (short) 4, I18N.tr("machine.furnace.progress", _2f(pass * 100))));
    }
    if (pass >= 1) {
      holder.getInventory().setItem(Furnace.PROGRESS_SLOTS.get(0), GuiItemCreater.getItem("ORANGE_STAINED_GLASS_PANE",
          "STAINED_GLASS_PANE", (short) 1, I18N.tr("machine.furnace.progress", _2f(pass * 100))));
    }
    if (amount >= 1) {
      holder.getInventory().setItem(49, GuiItemCreater.getItem("LIME_STAINED_GLASS_PANE", "STAINED_GLASS_PANE",
