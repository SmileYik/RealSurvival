...
public class CraftTableOpenEvent implements Runnable {
  ...
  public void run() {
    ...
    pass %= 1;
    if (amount < 1) {
      holder.getInventory().setItem(49, GuiItemCreater.getItem("RED_STAINED_GLASS_PANE", "STAINED_GLASS_PANE",
          (short) 14, I18N.tr("machine.craft-table.ok-slot-name", _2f(pass * 100))));
    } else {
      holder.getInventory().setItem(49, GuiItemCreater.getItem("GREEN_STAINED_GLASS_PANE", "STAINED_GLASS_PANE",
          (short) 5, I18N.tr("machine.craft-table.ok-slot-name-2", _2f(pass * 100), amount)));
    }
